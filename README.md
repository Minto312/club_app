...
**データベースの削除など、何でもしていただいて構いません**

不具合、質問等がございましたら、お手数ですが以下のメールアドレスまで、ご連絡いただけると幸いです。
- r2021219@tokai-shogyo.jp
- g2022199@tokai-shogyo.jp  

> [!NOTE]
> デプロイ中のソースコードはreleaseブランチのものを参照してください
